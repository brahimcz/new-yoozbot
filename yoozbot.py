...
bot = telebot.TeleBot("7065531741:AAEy_HlyhOnSzmnIN3j2wKbrsmUkDOsNGp8")

@bot.message_handler(commands=['start'])
def start(message):
    chat_id = message.chat.id
    bot.send_message(chat_id, ''' مرحبا في بوت انيس 🥰
            ...
            if response.status_code == 200 and not success_message_sent:
                ...
                if show_won_popup:
                    bot.send_message(chat_id, '''تم  ارسال الانترنت بنجاح ✅ 
                     ...
                     مطور البوت : @Brausma16
                     
                    قناة المطور : https://t.me/aniscofigs ''')
                else:
